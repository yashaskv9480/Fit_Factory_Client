  ...
  return (
    <>
      ...
      { 
          ...
          <NavLink to = {isClient && isAdmin && '/dashboard' || isUser && "/"}>
...

            {
              isauthenticated ?
                ...
                { isClient &&          
                    ...
                    <Tooltip title='Profile'>
                      <NavLink to='/update'>
                        <span className='nav-icon-span'>  <FitnessCenterIcon style={{ fontSize: 29, marginTop: 7,marginRight:10 }} /></span>
                      </NavLink>
                    </Tooltip>
                  </li>}
              ...
              <Tooltip >
                ...
                <Tooltip title="Client login/Signup">
                  ...
                  <NavLink to="/client/register">
                    <span className='nav-icon-span'> Client Signup <Badge badgeContent={setProceed ? cart.length : 0}> <FitnessCenterIcon className='nav-icon' /></Badge></span>
                  </NavLink>
                </Tooltip>
              </li>
                <li className="nav-links">
